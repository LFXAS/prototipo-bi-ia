...
La versión actual conserva la infraestructura del Sprint 1 y el núcleo administrativo del Sprint 2: autenticación JWT, RBAC, auditoría y configuración LLM. Sprint 3 añade parámetros tipados, administración web de una fuente SQL Server e introspección determinística con instantáneas inmutables y explorador de esquema. Interpretación semántica, propuesta asistida, ETL, datamart, dashboard, reportería y Copiloto BI continúan fuera de este incremento.
...
\begin{tabularx}{\textwidth}{@{}>{\bfseries}p{0.26\textwidth}X@{}}
  ...
  Campo & Valor \\
  \midrule
  Estado & Manual acumulativo del Sprint 1, Sprint 2 y dos incrementos funcionales del Sprint 3; base obligatoria para los módulos posteriores con SDD. \\
