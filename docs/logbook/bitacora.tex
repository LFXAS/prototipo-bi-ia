...
\begin{tabularx}{\textwidth}{@{}X l X@{}}
  ...
  Backend calidad y pruebas & \statusok & Ruff, Mypy y 18 pruebas Pytest dentro de Docker \\
  Frontend calidad y pruebas & \statusok & ESLint, 6 pruebas Vitest y build de Vite dentro de Docker \\
  ...
  SDD y trazabilidad & \statusok & Guía, plantilla y contratos del Sprint 3 versionados; parametrización implementada antes de iniciar introspección. \\
  \bottomrule
\end{tabularx}
...
\begin{enumerate}
  \item Implementar SPR-03-01 sobre la conexión activa: instantánea canónica, hash, deduplicación y explorador de sólo lectura.
  \item Mantener la parametrización y la credencial de la fuente como prerrequisitos visibles del recorrido guiado.
  \item Implementar después la interpretación semántica y propuesta supervisada de SPR-03-02 y SPR-03-03.
