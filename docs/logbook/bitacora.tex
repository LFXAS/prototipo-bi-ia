...
\begin{tabularx}{\textwidth}{@{}X l X@{}}
  ...
  Backend calidad y pruebas & \statusok & Ruff, Mypy y 48 pruebas Pytest dentro de Docker \\
  Frontend calidad y pruebas & \statusok & ESLint, 9 pruebas Vitest y build de Vite dentro de Docker \\
...
\begin{enumerate}
  \item Ejecutar la prueba de aceptación del Sprint 3 y corregir observaciones antes de integrar a \file{develop}.
  \item Especificar el contrato ejecutable del Sprint 4 a partir de una propuesta aprobada e inmutable.
  \item Generar transformaciones determinísticas, materializar el datamart desde destino vacío y validar cifras contra consultas de referencia.
