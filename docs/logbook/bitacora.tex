...
\begin{tabularx}{\textwidth}{@{}X l X@{}}
  ...
  Git local & \statusok & Rama \file{main}; commit base \file{ead11fb} \\
...
\begin{enumerate}
  \item Recuperar la autenticación de GitHub y elegir nombre y visibilidad del repositorio.
  \item Publicar el repositorio y observar la primera ejecución CI/CD.
