...
\begin{longtable}{@{}p{0.20\textwidth}p{0.18\textwidth}p{0.54\textwidth}@{}}
  ...
  GitHub remoto & \statuspending & El cliente \file{gh} está autenticado como \file{LFXAS}. Falta decidir el nombre y la visibilidad antes de crear el remoto. \\
...
\begin{enumerate}
  \item Confirmar el nombre y la visibilidad del repositorio GitHub.
  \item Crear el remoto, publicar y observar la primera ejecución CI/CD.
