...
\begin{tabularx}{\textwidth}{@{}X l X@{}}
  ...
  Backend calidad y pruebas & \statusok & Ruff, Mypy y 21 pruebas Pytest dentro de Docker \\
  Frontend calidad y pruebas & \statusok & ESLint, 7 pruebas Vitest y build de Vite dentro de Docker \\
  ...
  SDD y trazabilidad & \statusok & SPR-03-01 implementada: instantánea, hash, deduplicación, permisos, auditoría y explorador vinculados a evidencia real. \\
  \bottomrule
\end{tabularx}
...
\begin{enumerate}
  \item Implementar la solicitud guiada de negocio y la interpretación semántica en español sobre la instantánea vigente.
  \item Consumir \file{METADATA\_BLOCK\_MAX\_ITEMS} para dividir el contexto enviado al proveedor LLM activo.
  \item Validar referencias propuestas contra tablas, columnas y relaciones reales antes de mostrarlas al analista BI.
