...
\begin{longtable}{@{}p{0.22\textwidth}p{0.18\textwidth}p{0.52\textwidth}@{}}
  ...
  Visibilidad GHCR & \statuspending & La descarga anónima de los cinco paquetes respondió HTTP 401. El repositorio público no cambia automáticamente los paquetes; hasta ajustar su visibilidad, otras máquinas deben autenticarse con \file{read:packages}. \\
  \bottomrule
\end{longtable}
...
\begin{tabularx}{\textwidth}{@{}X l X@{}}
  ...
  GitHub/GHCR & \statusok & Repositorio público, dos colaboradoras con escritura, ramas protegidas y cinco imágenes publicadas en GHCR \\
  \bottomrule
\end{tabularx}
...
\begin{enumerate}
  \item Cambiar a pública la visibilidad de los cinco paquetes GHCR y repetir la descarga anónima.
