...
\begin{longtable}{@{}p{0.22\textwidth}p{0.18\textwidth}p{0.52\textwidth}@{}}
  ...
  \midrule
  \endhead
  Separación editorial & \statusok & El manual, la bitácora y los cuatro informes de sprint conservan el detalle técnico completo sin identidad institucional. No se eliminaron decisiones, incidencias, comandos, resultados ni trazabilidad. \\
  ...
  Automatización documental & \statusok & Make y CI compilan siete PDF oficiales y verifican que las versiones generadas coincidan con sus fuentes. \\
...
\begin{tabularx}{\textwidth}{@{}X l X@{}}
  ...
  Backend calidad y pruebas & \statusok & Ruff, formato, Mypy y 76 pruebas Pytest dentro de Docker \\
  ...
  SDD y trazabilidad & \statusok & SPR-03-01 a SPR-03-05 implementadas: conexión, instantánea, explorador, propuesta asistida, validación, decisión humana y experiencia guiada. \\
  \bottomrule
\end{tabularx}
...
\begin{enumerate}
  ...
  \item Diseñar en un incremento posterior una operación explícita de actualización periódica de datos, diferenciada de la carga inicial y con identidad, controles y evidencia propios.
  \item Integrar el cierre de Sprint 4 mediante pull request después de confirmar la experiencia de usuario y la documentación completa.
  \item Mantener dashboards, hallazgos y pronóstico dentro del alcance aprobado de sus sprints posteriores.
