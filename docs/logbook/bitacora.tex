...
\begin{longtable}{@{}p{0.22\textwidth}p{0.18\textwidth}p{0.52\textwidth}@{}}
  ...
  \midrule
  \endhead
  Migración Sprint 2 & \statusok & Se incorporó la revisión Alembic \file{20260906\_01}, que crea en el esquema \file{app} las tablas de RBAC, auditoría, parámetros y configuración LLM no secreta. El servicio \file{migrate} la ejecuta antes de FastAPI. \\
  ...
  Interfaz base & \statusok & React incorpora acceso, cierre de sesión, navegación derivada de permisos, avisos y vistas de consulta para los recursos del sprint. El cascarón usa CSS responsive desde 320 px. \\
  ...
  Pendiente de cierre & \statuspending & Faltan formularios administrativos completos en React, pruebas negativas de autorización y de adaptadores, evidencia visual responsive, \file{make verify} final y el PR hacia \file{develop}. \\
