...
\begin{longtable}{@{}p{0.22\textwidth}p{0.18\textwidth}p{0.52\textwidth}@{}}
  ...
  Interfaz administrativa & \statusok & React incorpora acceso, cierre de sesión, navegación derivada de permisos, avisos, formularios de alta y edición, asociaciones por identificadores y activación/desactivación lógica para usuarios, roles, permisos, menús, parámetros y configuración LLM. La auditoría queda exclusivamente en consulta. El cascarón usa CSS responsive desde 320 px. \\
