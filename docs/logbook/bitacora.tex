...
\begin{tabularx}{\textwidth}{@{}X l X@{}}
  ...
  Ollama local opcional & \statusok & Perfil \file{local-llm}, modelo \file{qwen3:4b} persistente y prueba FastAPI de servicio más modelo, sin puerto público ni descarga CI \\
