...
\begin{longtable}{@{}p{0.22\textwidth}p{0.18\textwidth}p{0.52\textwidth}@{}}
  ...
  Entrega Git & \statusok & La mejora se consolidó en la rama \file{docs/ampliar-manuales-sprint-1}, se verificó antes de publicarla y se preparó el PR documental hacia \file{develop} bajo el flujo protegido. \\
  \bottomrule
\end{longtable}
