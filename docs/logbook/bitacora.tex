...
\begin{longtable}{@{}p{0.22\textwidth}p{0.18\textwidth}p{0.52\textwidth}@{}}
  ...
  Especificaciones & \statusok & Se crean el índice SPR-03 y tres contratos para conexión e introspección, propuesta BI asistida y experiencia de exploración/revisión. Todos permanecen en borrador hasta aprobación humana. \\
  Separación de responsabilidades & \statusok & La aplicación conecta, normaliza, valida y audita; el LLM propone un documento estructurado; una persona aprueba o rechaza. Ninguna propuesta ejecuta SQL o ETL. \\
  Decisión arquitectónica & \statusok & El ADR 0003 propone instantáneas inmutables, paquete compacto de metadatos, contrato JSON versionado, validadores determinísticos y puerta de aprobación. \\
...
\begin{enumerate}
  ...
  \item Resolver las tres decisiones humanas pendientes: selección del alcance, permiso de aprobación y sustitución de versiones.
