...
\begin{enumerate}
  ...
  \item El mismo bloqueo de escritura impidió actualizar la bitácora durante esa intervención. No hubo pérdida ni corrupción: el árbol Git permaneció limpio y la presente versión 0.1.7 registra la resolución en una sesión posterior.
\end{enumerate}
...
\begin{tabularx}{\textwidth}{@{}X l X@{}}
  ...
  GitHub/GHCR & \statusok & Repositorio público, dos colaboradoras con escritura, ramas protegidas y cinco imágenes públicas en GHCR; la réplica desde un segundo computador queda como evidencia pendiente. \\
  \bottomrule
\end{tabularx}
...
\begin{enumerate}
  \item Obtener una aprobación de \file{LeslyVelasquez} o \file{EmyRoblesBerry} en el PR 12; la fusión automática incorporará entonces los cambios en \file{develop}.
  \item Clonar el repositorio en un segundo computador, levantar la entrega pública sin iniciar sesión en GHCR y conservar las sondas de salud y los digest como evidencia.
