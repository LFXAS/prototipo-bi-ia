...
\clearpage
\subsection{4 de septiembre de 2026 - Especificación UX responsive del Sprint 2}
...
La plataforma usará un cascarón React reusable y menús derivados de permisos ya validados por FastAPI. La interfaz ofrece orientación y prevención de errores, pero no reemplaza las decisiones de autorización del backend. Se privilegiarán componentes nativos y CSS mantenible; una biblioteca visual externa sólo se evaluará con justificación explícita.
