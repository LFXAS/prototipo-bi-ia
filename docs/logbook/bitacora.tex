...
\begin{longtable}{@{}p{0.22\textwidth}p{0.18\textwidth}p{0.52\textwidth}@{}}
  ...
  Especificaciones & \statusok & Se crean y refinan el índice SPR-03 y tres contratos para conexión e introspección, solicitud guiada, propuesta BI asistida y experiencia de exploración/revisión. Todos permanecen en borrador hasta aprobación humana. \\
  ...
  Decisión arquitectónica & \statusok & El ADR 0003 define instantáneas inmutables, perfil y glosario de ventas, contrato JSON, validadores y puerta de aprobación. Sprint 4 deberá incorporar un constructor determinístico y ejecutor backend, no consultas manuales por análisis. \\
...
\begin{enumerate}
  \item Revisar y aprobar las especificaciones SPR-03-01, SPR-03-02 y SPR-03-03 antes de escribir código funcional.
