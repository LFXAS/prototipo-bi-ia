...
| [SPR-04-01-seleccion-propuesta-y-validacion-etl.md](SPR-04-01-seleccion-propuesta-y-validacion-etl.md) | implementada y conciliada | Selección explícita de una propuesta aprobada, comparación, trazabilidad de ejecución y conciliación OLTP-datamart. |
| [SPR-04-02-kpis-controlados-y-calculables.md](SPR-04-02-kpis-controlados-y-calculables.md) | implementada y conciliada | KPI variables sugeridos por IA, recetas determinísticas, límites semánticos y evidencia de conciliación. |
