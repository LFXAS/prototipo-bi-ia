...
| [SPR-04-02-kpis-controlados-y-calculables.md](SPR-04-02-kpis-controlados-y-calculables.md) | aprobación técnica previa a implementación | KPI variables sugeridos por IA, recetas determinísticas, límites semánticos y evidencia de conciliación. |
| [SPR-04-03-ui-ux-materializacion-y-validacion.md](SPR-04-03-ui-ux-materializacion-y-validacion.md) | aprobación técnica previa a implementación | Recorrido profesional del analista para seleccionar, ejecutar, validar y recuperar un datamart. |
