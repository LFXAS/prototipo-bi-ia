...
4. Enlazar el archivo desde el PR y actualizar el estado durante el ciclo.
5. Conservar el documento después de la entrega; no se sustituye por el README ni por la bitácora.
...
|---|---|---|
| [SPR-02-rbac-y-parametros.md](SPR-02-rbac-y-parametros.md) | borrador | Base de seguridad RBAC y parámetros de conexión aprobados. |
