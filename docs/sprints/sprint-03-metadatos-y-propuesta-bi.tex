...
\begin{titlepage}
  ...
  \begin{tabularx}{\textwidth}{@{}>{\bfseries}l X@{}}
    ...
    Estado & Implementación y verificación técnica completadas; pendiente prueba de aceptación \\
...
\begin{longtable}{@{}p{0.25\textwidth}p{0.56\textwidth}p{0.13\textwidth}@{}}
  \toprule
  ...
  Aceptación & Recorrido manual por las autoras sobre el entorno integrado. & \review \\
  \bottomrule
\end{longtable}
...
La instantánea usa un contrato canónico independiente del lector. \file{CONNECTOR\_READERS} registra adaptadores y actualmente habilita \file{sqlserver}. Para MySQL se deberá implementar lectura de \file{information\_schema}, mapeo canónico, campos de configuración, prueba de sólo lectura y pruebas automatizadas antes de mostrarlo en la interfaz.
...
El incremento se considera técnicamente listo cuando código, migraciones, pruebas, documentación y entorno integrado superan \file{make verify}. La fusión a \file{develop} se realizará después de la prueba funcional de las autoras y la corrección de cualquier observación. No se crea un pull request desde este informe antes de esa aceptación.
