...
\begin{tabularx}{\textwidth}{@{}>{\bfseries}p{0.27\textwidth}X@{}}
  ...
  Objetivo & Dejar el entorno completo ejecutándose desde cero con Docker y publicarlo de forma privada y repetible. \\
...
\subsection{Inicialización de Git y publicación privada}

Se inicializó Git con \file{main}, se aplicó una política para excluir secretos y datos locales, y se creó el repositorio privado \href{https://github.com/LFXAS/prototipo-bi-ia}{LFXAS/prototipo-bi-ia}. Las contribuciones siguen Conventional Commits y una plantilla de pull request.

\subsection{Integración y entrega continuas}

CI valida Compose y construye las etapas de prueba de frontend, backend e infraestructura. CD vuelve a comprobar la entrega y publica cinco imágenes privadas: frontend, backend, PostgreSQL, SQL Server y documentación. Las etiquetas incluyen rama, versión y SHA.
...
Se crearon README, guía de réplica, descripción de arquitectura, ADR y bitácora LaTeX. El repositorio incluye reglas para que futuras sesiones de desarrollo actualicen pruebas y documentos antes de entregar cambios.
...
\begin{tabularx}{\textwidth}{@{}X l X@{}}
  ...
  GHCR & Publicado & Cinco imágenes privadas con etiquetas \file{main} y \file{sha-*} \\
  \bottomrule
\end{tabularx}
...
\begin{itemize}
  ...
  \item[\textbf{Cumple.}] El repositorio privado y las cinco imágenes quedaron publicados.
...
\begin{tabularx}{\textwidth}{@{}>{\bfseries}p{0.20\textwidth}X@{}}
  ...
  Próxima acción & Implementar el núcleo RBAC y los parámetros mediante migraciones y pruebas. \\
  \bottomrule
\end{tabularx}
...
\begin{enumerate}
  ...
  \item invitación de colaboradoras cuando se obtengan sus nombres de usuario GitHub.
\end{enumerate}
