...
La denominación Sprint 1 es válida porque existieron un objetivo acotado, un conjunto priorizado de elementos de trabajo, criterios de aceptación, un incremento ejecutable, revisión mediante evidencias y una retrospectiva. Este informe formaliza dichas actividades para su incorporación en la documentación consolidada del proyecto; no pretende afirmar ceremonias o métricas que no se hayan observado.
...
\input{detalle-tecnico-sprint-01.tex}
...
\subsection{Nota de evolución posterior}

El perfil Docker opcional de Ollama y su modelo local se incorporan posteriormente como extensión del Sprint 2 para probar la configuración LLM. No forman parte del alcance ni de la evidencia histórica del Sprint 1; reutilizan la base Docker, los volúmenes nombrados y las prácticas de configuración segura establecidas en este informe. Su operación y verificación se documentan en el manual técnico vigente.
...
\begin{tabularx}{\textwidth}{@{}>{\bfseries}p{0.28\textwidth}X@{}}
  ...
  \midrule
  Código & INF-SPR-01 \\
  Fuente editable & \path{docs/sprints/sprint-01-entorno.tex} \\
  Compilación & \path{make sprint-report} o \path{make docs} \\
  Evidencia relacionada & Bitácora, manual técnico, especificación de cierre y PR \#15. \\
  Actualización & Sólo ante corrección histórica o cambio verificable en la evidencia del Sprint 1. \\
  \bottomrule
\end{tabularx}
...
\begin{tabularx}{\textwidth}{@{}p{0.14\textwidth}p{0.18\textwidth}X@{}}
  ...
  \midrule
  1.0.0 & 24-09-2026 & Normalización profesional del informe sin eliminar el detalle técnico, las incidencias ni la evidencia histórica. \\
  \bottomrule
\end{tabularx}
